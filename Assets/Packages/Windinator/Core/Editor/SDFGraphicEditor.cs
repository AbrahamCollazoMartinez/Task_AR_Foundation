...
public class SDFGraphicEditor : Editor
{
    ...
    public static void DrawSDFScene(SignedDistanceFieldGraphic graphic)
    {
        ...
        if (circleSettings)
        {
            ...
            var fmh_304_59_638567810594514476 = Quaternion.identity; actualPos = Handles.FreeMoveHandle(actualPos, 3f, Vector3.one, Handles.SphereHandleCap);
        ...
        if (maskSettings)
        {
            ...
            var fmh_329_55_638567810594540334 = Quaternion.identity; maskPos = Handles.FreeMoveHandle(maskPos, 3f, Vector3.one, Handles.SphereHandleCap);
    ...
    public void OnSceneGUI()
    {
        ...
        if (m_showPoints)
        {
            ...
            for (int i = 0; i < graphic.Points.Length; ++i)
            {
                ...
                var fmh_522_63_638567810594546855 = Quaternion.identity; actualPos = Handles.FreeMoveHandle(actualPos, 5f, Vector3.zero, Handles.SphereHandleCap);
    ...
    public void OnSceneGUI()
    {
        ...
        if (m_showPoints)
        {
            ...
            for (int i = 0; i < graphic.Points.Length; ++i)
            {
                ...
                var fmh_660_63_638567810594552014 = Quaternion.identity; actualPos = Handles.FreeMoveHandle(actualPos, 5f, Vector3.zero, Handles.SphereHandleCap);
